...
class IntraNoticeDao {
  static const String STORE_NAME = 'intraNotice';
...
Future<List<Notice>> getNotices() async {
  ...
  try {
    Response response =
        await Dio().post(intranet, data: {"uid": id, "pwd": password});
...
//    await NoticeDao().deleteDB();
    ...
    print('error in IntraNotice repo getNotices()');
